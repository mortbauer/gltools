...
cdef class Window:
    ...
    '''
    def __init__(self, int width = -1, int height = -1, title = '',
        ...
        if width < 0 or height < 0:
            ...
            self.thisptr = glfwCreateWindow(width, height, c_title, NULL, NULL)
    ...
    cpdef bint shouldClose(self):
        return glfwWindowShouldClose(<GLFWwindow *>self.thisptr)
